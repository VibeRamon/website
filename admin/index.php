...
include("includes/db.php");
  ...
  // $get_purchases = "select * from purchases";
  // $run_purchases = mysqli_query($con,$get_purchases);
  // $count_purchases = mysqli_num_rows($run_purchases);
  ...
  $get_schools = "select * from schools";
  $run_schools = mysqli_query($con,$get_schools);
  $count_students = mysqli_num_rows($run_schools);
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_orders; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_products; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $count_suppliers; ?></div>
                        </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count_purchases; ?></div>
                    </div>
                    <div class="col-auto">
